...
#ifndef DC_VM_HYPERVISOR_APPLICATION_HELPER_H
#define DC_VM_HYPERVISOR_APPLICATION_HELPER_H
 ...
 * on a set of nodes.
 */
class DcVmHypervisorApplicationHelper
{
public:
  /**
   ...
   *        to.
   */
  DcVmHypervisorApplicationHelper (std::string protocol, Address address);

  DcVmHypervisorApplicationHelper ();
