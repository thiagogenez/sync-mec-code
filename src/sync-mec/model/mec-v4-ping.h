/*
 * mec-latency-monitor.h
 *
 *  Created on: 9 Jul 2017
 *      Author: thiagogenez
 */

#ifndef MEC_LATENCY_MONITOR_H_
#define MEC_LATENCY_MONITOR_H_
 ...
 */
class MecV4Ping: public Application {
public:
	/**
...
private:
	...
	// callback purposes
	Callback<void,  uint32_t, double> m_pongCallback; //!< connection succeeded callback

	Ptr<MecE2ECheckerHelper> m_e2eHelper;
};

} // namespace ns3

#endif /* MEC_LATENCY_MONITOR_H_ */
